...
class PrivateAdminCourseEditScreen extends BasePrivateScreen {
  PrivateAdminCourseEditScreen(UserModel userModel) : super(userModel);
  ...
  @override
  title() {
    return CustomText('Haftalık PT Ders Gün ve Saatleri',
